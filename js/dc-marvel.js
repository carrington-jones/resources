...
transformButton.onclick = function () {
    ...
    //This code changes the color of the hulk from black to green to pink. And the Hulk to Bruce Banner
    var hulkNameElement = document.getElementById("theHulk");
    if (hulkStrength === "super") {
        hulkNameElement.style.color = "green";
        hulkNameElement.innerHTML = hulkState
    } else {
        hulkNameElement.style.color = "hotpink";
        hulkNameElement.innerHTML = hulkState
    }
    console.log(hulkState + " is currently in " + hulkState + " his strength is " + hulkStrength + " and his intelligence is " + hulkIntelligence)
}
